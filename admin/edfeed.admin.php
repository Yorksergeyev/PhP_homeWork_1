...
<section class="columns has-background-info is-centered">
    <div class="column is-four-fifths has-text-centered">
     ...
     <th>  <button class='button  is-danger delete_otz' id={$feedback_more['id'][$i]}> Удалить</button> </th>
     <th>  <button class='button  is-black activе_it ' id={$feedback_more['id'][$i]}>Показать отзыв</button> </th>
     <th>  <button class='button  is-black deactive_it ' id={$feedback_more['id'][$i]}>Запретить отзыв</button> </th>
    </tr>";    }
                    ?>
                </table>
            </div>
